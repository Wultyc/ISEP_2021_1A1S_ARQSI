...
{
    public partial class Viajantes2VMDContext : DbContext
    {
        public Viajantes2VMDContext()
        {
        }

        public Viajantes2VMDContext(DbContextOptions<Viajantes2VMDContext> options)
            : base(options)
        {
        }
